        ...
        <div id="content" class="black">
                ...
                <div class="content">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php } ?>
                            <td colspan="6"><center><h2>Aucun Client actuellement</h2></center></td>
                            </tr>
            ...
            <div class="bloc">
                ...
                <div class="content">
                    ...
                    <a href="<?php echo $rootsite; ?>core/intervention-info/client/modif.php" class="shortcut">
                        <img src="<?php echo $rootsite; ?>img/icons/button-load.png" alt=""  width="32" height="32"/>
                        Modifier Client
                    </a>
                    <a href="<?php echo $rootsite; ?>core/intervention-info/client/supp.php" class="shortcut">
