...
?>           
        ...
        <div id="content" class="black">
            ...
            <div class="bloc">
                ...
                <div class="content">
                    <table>
                        ...
                        <tbody>
                            <?php
                                $query_client = mysql_query("SELECT * FROM client_informatique");
            ...
            <div class="bloc">
                ...
                <div class="content">
                    <a href="<?php echo $rootsite; ?>core/intervention-info/client/new.php" class="shortcut">
                        <img src="<?php echo $rootsite; ?>img/icons/button-add.png" alt="" />
                        Nouveau Client
                    </a>
                    <a href="<?php echo $rootsite; ?>core/intervention-info/client/select.modif.php" class="shortcut">
                        <img src="<?php echo $rootsite; ?>img/icons/button-load.png" alt=""  width="32" height="32"/>
                        Modifier Client
                    </a>
                    <a href="<?php echo $rootsite; ?>core/intervention-info/client/select.supp.php" class="shortcut">
